...
class SerialCom(threading.Thread):
    ...
    def Comandos(self):
        ...
        self.PDILerStatus        = 'STB,'        #Le status do integrador binario
        self.PDILerStatusH       = 'STH,'        #Le status do integrador hexa
        ...
        self.PDITipodeTrigger    = 'TRS,E,'      #Tipo de Trigger encoder incremental rotativo
        ...
        self.PDITriggerExterno   = 'TRS,X'       #Configura integrador por trigger externo 
    ...
    def StatusH(self,registrador):
        self.Enviar(self.PDILerStatusH + registrador)
        time.sleep(0.1)
        leitura = self.Ler(10)
        return leitura
