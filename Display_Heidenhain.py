...
class SerialCom_ND760(threading.Thread):
...
##            print(leitura)
    ...
    def Enviar_Tecla(self,Tecla):
        try:
            self.ser.write(Tecla.encode('utf-8'))
            time.sleep(.1)
...
class SerialCom_ND780(object):
    ...
    def LerDisplay(self):
        try:
            ...
            aux1 = leitura[leitura.find('A=')+2:leitura.find(' R\r\n')]
            aux1 = aux1.replace(' ','')

            leitura = leitura[leitura.find('R\r\n')+3:]
            aux2 = leitura[leitura.find('B=')+2:leitura.find(' R\r\n')]
            aux2 = aux2.replace(' ','')

##            leitura = leitura[leitura.find('R\r\n')+3:]
##            aux3 = leitura[leitura.find('C=')+2:leitura.find(' R\r\n')]
##            aux3 = aux3.replace(' ','')
